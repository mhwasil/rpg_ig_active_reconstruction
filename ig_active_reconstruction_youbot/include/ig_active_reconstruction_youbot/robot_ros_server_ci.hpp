...
//using namespace ig_active_reconstruction;
...
namespace robot
{
   ...
   */
  class YoubotRosServerCI: public ig_active_reconstruction::robot::YoubotCommunicationInterface
  {
  public:
    /*! Constructor
     ...
     */
    YoubotRosServerCI( ros::NodeHandle nh, boost::shared_ptr<YoubotCommunicationInterface> linked_interface = nullptr );
    
    /*! Set a new linked interface to which the class forwards all requests.
     * @param linked_interface Interface pointer.
     */
    void setLinkedInterface( boost::shared_ptr<YoubotCommunicationInterface> linked_interface );
    ...
    */
    ...
    virtual bool moveUsingJoints ( std::map<std::string, double>& joints_map );
  ...
  protected:
    ...
    boost::shared_ptr<YoubotCommunicationInterface> linked_interface_; //! Linked interface.
